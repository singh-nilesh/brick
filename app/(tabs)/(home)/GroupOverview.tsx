    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            {showDatePicker && selectedTaskIndex !== null && (
                <CalendarDatePicker visible={showDatePicker} onClose={() => setShowDatePicker(false)} 
                selectedDate={tasks[selectedTaskIndex].dueAt || new Date()} setSelectedDate={handleDateChange} />)}
